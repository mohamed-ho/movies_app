...
class MoreTvScreen extends StatelessWidget {
  MoreTvScreen({super.key, required this.type});
  String type;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider<TvBloc>(
        create: (context) => type == AppStrings.populareScreenType
            ? (ls<TvBloc>()..add(PopulareTvEvent()))
            : (ls<TvBloc>()..add(TopRateTvEvent())),
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  TvDetailsScreen(id: movie[index].id))),
                      child: Container(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      movie[index].name!.length > 23
                                          ? '${movie[index].name!.substring(0, 23)}...'
                                          : movie[index].name!,
